...
//		cin >> videoIndex_i;
//
//		char *name[10] = { "./datasets/01_david/david.mp4", "./datasets/02_jumping/jumping.mpg",
...
int main()
{
	...
	std::ifstream vediosname;
	vediosname.open("D://kcfTLD//Judge//experiment//vedionames.txt");

	while (!vediosname.eof())
	{
		char t[150];
		vediosname.getline(t, 150);
		string basename = t;

		basename.erase(basename.end() - 5, basename.end());
		cout << "[...........]" << endl << basename << endl << "[...........]" << endl << endl;

		string filename;
		filename = "D://kcfTLD//Judge//dataset//" + basename + ".avi";
		...
		readBB("D://kcfTLD//Judge//dataset//" + basename + "_init.txt");
		...
		clock_t start, stop;
		start = clock();
		ff.open("D://kcfTLD//Judge//experiment//" + basename + "_result.txt");
		while (capture.read(NextImg_cvM))
		{
